...
namespace nsK2Engine {
    ...
    {
        // 太陽光
        m_light.directionalLight[0].color.x = 0.0f;
        m_light.directionalLight[0].color.y = 0.0f;
        m_light.directionalLight[0].color.z = 0.0f;

        m_light.directionalLight[0].direction.x = 0.0f;
        m_light.directionalLight[0].direction.y = 1.0f;
        m_light.directionalLight[0].direction.z = 0.0f;
      ...
      /*  m_light.directionalLight[1].color.x = 1.0f;
        ...
        m_light.ambinetLight.x = 0.0000001f;
        m_light.ambinetLight.y = 0.0000001f;
        m_light.ambinetLight.z = 0.0000001f;
